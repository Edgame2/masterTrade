...
HIGH_VOLUME_SYMBOLS = ["ETHUSDT", "BNBUSDT", "ADAUSDT", "SOLUSDT", "DOGEUSDT", "MATICUSDT", "DOTUSDT", "AVAXUSDT"]
VOLATILE_SYMBOLS = ["ETHUSDT", "SOLUSDT", "AVAXUSDT", "ATOMUSDT", "NEARUSDT", "FTMUSDT", "SANDUSDT"]
STABLE_SYMBOLS = ["ETHUSDT", "BNBUSDT", "ADAUSDT", "XLMUSDT", "TRXUSDT", "LTCUSDT"]
ALTCOIN_SYMBOLS = ["ADAUSDT", "DOGEUSDT", "MATICUSDT", "LINKUSDT", "UNIUSDT", "ATOMUSDT", "XLMUSDT"]
ALL_SYMBOLS = ["ETHUSDT", "BNBUSDT", "ADAUSDT", "SOLUSDT", "DOGEUSDT", "MATICUSDT", "DOTUSDT", 
               "AVAXUSDT", "LINKUSDT", "ATOMUSDT", "UNIUSDT", "XLMUSDT", "NEARUSDT", "FTMUSDT", 
               "SANDUSDT", "MANAUSDT", "TRXUSDT", "LTCUSDT", "ETCUSDT", "XRPUSDT"]
